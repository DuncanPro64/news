...
<head>
  ...
  <title>Campus Vibes | Compose Message</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <?php  include('../../include/msgdrop.php'); ?>
  <!-- /.navbar -->
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-footer">
                <div class="float-right">
                  ...
                  <button type="submit" class="btn btn-primary" name="publish"><i class="far fa-envelope"></i> Publish</button>
                </div>
